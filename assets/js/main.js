...
function scrollTop(){
    ...
    // When the scroll is higher 560 viewport height, add the show-scroll class to the tag with the scroll-top class
...
sr.reveal(' .home, .about__data, .about__img, .services__content, .product, .size__data, .size__img, .contact__data, .contact__button, .footer__content, .detail__img, .detail__data', {
  interval:200
} )
